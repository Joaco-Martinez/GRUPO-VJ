...
function formatFechaTicket(date) {
...
function buildTicketPayload(sale) {
    ...
    return {
        ...
        items: sale.items.map((item) => {
            ...
            const subtotalItem = item.subtotal !== null && item.subtotal !== undefined
